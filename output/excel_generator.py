...
def generate_excel_report(
    ...
    worksheet.write('A6', "Ejercicio Fiscal:", cell_format)
    worksheet.write('B6', audit_data.get('periodo', 'N/A'), cell_format)
    worksheet.write('A7', "Jurisdicción:", cell_format)
    worksheet.write('B7', audit_data.get('provincia', 'N/A'), cell_format)
    worksheet.write('A8', "Volumen Anual:", cell_format)
    worksheet.write('B8', audit_data.get('volumen', 0.0), workbook.add_format({'num_format': '$ #,##0.00', 'border': 1}))
